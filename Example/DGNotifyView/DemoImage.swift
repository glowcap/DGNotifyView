...
public class DemoImage : NSObject {
  ...
  @objc public dynamic class func drawDemo(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 200, height: 200), resizing: ResizingBehavior = .aspectFit) {
    ...
    let label3FontAttributes: [NSAttributedString.Key: Any] = [
    ...
    let label2FontAttributes: [NSAttributedString.Key: Any] = [
      .font: UIFont(name: "AvenirNext-DemiBold", size: 203)!,
    ...
    let labelFontAttributes: [NSAttributedString.Key: Any] = [
      .font: UIFont(name: "AvenirNext-DemiBold", size: 203)!,
      .foregroundColor: textForeground,
